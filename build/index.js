...
const BarChart = () => {
  const {
    state,
    dispatch
  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(_ScaleContext__WEBPACK_IMPORTED_MODULE_3__.ScaleContext);
  ...
  const data = {
    ...
    datasets: [{
      ...
      data: [5, 10, 35],
      backgroundColor: [state.unlikelyRate, state.neutralRate, state.veryLikelyRate]
    }]
  };
...
function Configuration(_ref) {
  ...
  }, "Very Unlikely Score"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    className: "label--value",
    name: "label--title"

    //value={state.scale.lblLeft}
    //onChange={(e) => handleLabelChange('left', e.target.value)}
  }, "30%")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "configure--question"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    className: "label--rate"
  }, "Neutral Score"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    className: "label--value",
    name: "scale_question"
    // value={state.scale.lblCenter}
    // onChange={(e) => handleLabelChange('center', e.target.value)}
  }, "40%")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "configure--question"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    className: "label--rate"
  }, "Very Likely Score"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    className: "label--value",
    name: "scale_question"
    // value={state.scale.lblCenter}
    // onChange={(e) => handleLabelChange('center', e.target.value)}
...
/* harmony import */ var _PieChart__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../PieChart */ "./src/components/PieChart.js");
/* harmony import */ var react_dragswitch_dist_index_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! react-dragswitch/dist/index.css */ "./node_modules/react-dragswitch/dist/index.css");
/* harmony import */ var _BarChart__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../BarChart */ "./src/components/BarChart.js");
...
function Sidebar(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, sideBar && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "time"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", null, "Show Labels"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("small", {
    className: "toggle"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_dragswitch__WEBPACK_IMPORTED_MODULE_5__.DragSwitch, {
    ...
    className: "time"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", null, "Set Unlikely Color")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "color",
    className: "time--input",
    value: state.unlikelyRate,
    onChange: handleUnLikelyRate
  }), console.log(state.unlikelyRate)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sidebar_element_eight"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "time"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", null, "Set Neutral Color")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "color",
    className: "time--input",
    value: state.neutralRate,
    onChange: handleNeutralRate
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sidebar_element_eight"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "time"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", null, "Set likely Color")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "color",
    className: "time--input",
    value: state.veryLikelyRate,
    onChange: handleVeryLikelyRate
  }))) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Configuration__WEBPACK_IMPORTED_MODULE_4__["default"], {
    setAttributes: setAttributes
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    onClick: hideSetting,
    className: "use_scale"
...
/***/ "./node_modules/react-dragswitch/dist/index.css":
/*!******************************************************!*\
  !*** ./node_modules/react-dragswitch/dist/index.css ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/react-dragswitch/dist/index.modern.js":
/*!************************************************************!*\
  !*** ./node_modules/react-dragswitch/dist/index.modern.js ***!
  \************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DragSwitch: function() { return /* binding */ DragSwitch; },
...
var ToggleSwitch = function ToggleSwitch(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("label", Object.assign({
    style: {
...
var DragSwitch = function DragSwitch(_ref) {
  ...
  var switchRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);

  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(checked ? 20 : 0),
      Xpos = _useState[0],
      setPos = _useState[1];
